...
//INSERT YOUR CODE HERE:
	Rectangle sum_Rectangle = Rectangle();
	for (int i = 0; i < number_of_rectangles ; i++)
	{
		sum_Rectangle = sum_Rectangle + all_rectangles[i];
	}
	return sum_Rectangle.area();
}
...
*  Use the member function perimeter() to return the calculate and return resulting perimeter
*/
int calc_perimeter_of_product_Rectangle(vector<Rectangle> all_rectangles){
	int number_of_rectangles = all_rectangles.size();
	//INSERT YOUR CODE HERE:
	Rectangle product_Rectangle = Rectangle(1,1);
	for (int i = 0; i < number_of_rectangles ; i++)
	{
		product_Rectangle = product_Rectangle * all_rectangles[i];
	}
	return product_Rectangle.perimeter();
}
